...
L["CMD_HELP_SHOW_DESC"] = "toggle played-time window"
L["CMD_HELP_DELETE_DESC"] = "remove a tracked character"
L["CMD_HELP_DEBUG_DESC"] = "list tracked character data"
...
L["SETTINGS_RESET_TIP"]       = "Restore all window settings to their defaults."
